    ...
    return (<>
        ...
        <nav className="container-fluid navbar-container">
            ...
            <ul className="menu-items">
                <li><input type="search" className="search" id="search" name="search" placeholder="Search"  /></li>
                <li>
                    <details role="list" dir="list">
                        <summary aria-haspopup="list-box" role="list">Items</summary>
                        <ul role="list-box">
                            <li><NavLink to="/products">Desktops</NavLink></li>
                            <li><NavLink to="/products">Laptops</NavLink></li>
                            <li><NavLink to="/products">Accesories</NavLink></li>
                            <li><NavLink to="/create">Create a product</NavLink></li>
                        </ul>
                    </details>
                </li>
                <li>
                ...
                <li>
                    <NavLink to="/" onClick={ChangeTheme}>{theme ? <i className="bi bi-sun"></i> : <i className="bi bi-moon"></i>}</NavLink>
                </li>
            </ul>
            <ul className="menu-icon">
                
                <li><NavLink to="/" onClick={changeMenu}><i className="bi bi-list"></i></NavLink></li>
            </ul>
                ...
                <ul>
                    ...
                    <li>
                        <details role="list" dir="list">
                            <summary aria-haspopup="list-box" role="list">Items</summary>
                            <ul role="list-box">
                                <li><NavLink to="/">Desktops</NavLink></li>
