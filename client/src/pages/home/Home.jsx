      ...
      <main className="container">
        <div className="grid">
          ...
          <section>
            ...
            <figure>
              <img src="assets/ashim-d-silva-3Ijt7UkSBYE-unsplash-1500x750.jpg" alt="Architecture"/>
          ...
          <aside>
            <a href="/" aria-label="Example" ><img src="assets/maarten-deckers-T5nXYXCf50I-unsplash-1500x750.jpg" alt="Architecture"/></a>
            <p>
              <a href="/" >Donec sit amet</a><br/>
                <small>Class aptent taciti sociosqu ad litora torquent per conubia nostra</small>
            </p>
            <a href="/" aria-label="Example" ><img src="assets/daniel-von-appen-tb4heMa-ZRo-unsplash-1500-750.jpg" alt="Architecture"/></a>
            <p>
              <a href="/" >Suspendisse potenti</a><br/>
                <small>Proin non condimentum tortor. Donec in feugiat sapien.</small>
            </p>
            <a href="/" aria-label="Example"><img src="assets/matthew-hamilton-Ru3Ap8TNcsk-unsplash-1500-750.jpg" alt="Architecture"/></a>
            <p>
